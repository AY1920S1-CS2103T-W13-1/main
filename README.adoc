...
* ModuleBook is a trackedModule planning application. It has a GUI but most of the user interactions happen using a CLI (Command Line Interface).
* ModuleBook helps to track deadlines and tasks, sends reminders, as well as information on trackedModules to help students plan their timetables.
...
* We would also like to acknowledge https://nusmods.com["NUSmods"] for providing sample trackedModule data from NUS
