...
// tag::searchfitering[]
=== [Partially implemented] Search filtering feature
...
* `DescriptionContainsKeywordsPredicate#test()` -- Tests that a `module` module code matches any of the keywords given.
