...
e.g. rename the tag `friends` to `buddies` (i.e. all trackedModules who had the `friends` tag will now have
...
----
+
The above method can be used to get a printable string representing a bunch of trackedModule details.
